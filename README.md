...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/mtproxytls/yanshide)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `ad806487-1d26-4636-98b6-ab85cc8521f7` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
| `AID` | `61` | 为进一步防止被探测所设额外 ID，即 AlterID，范围为 0 至 65535 |
